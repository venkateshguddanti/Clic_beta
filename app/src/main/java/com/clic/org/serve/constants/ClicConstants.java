package com.clic.org.serve.constants;

/**
 * Created by Venkatesh on 21-05-2016.
 */
public class ClicConstants {
    ...
    public static final String DOC_WARRANTY_VALUE= "1";
    public static final String DOC_INSURENCE_VALUE= "4";
    public static final String DOC_USERMANUAL_VALUE= "4";

    public static final String LISTTYPE_ACCESSORIES = "accessories";
    public static final String LISTTYPE_PRODUCTS_HOME = "productsHome";
    public static final String LISTTYPE_SERVICEREQ_HOME = "ServiceRequestHome";
    public static final String LISTTYPE_NORMAL = "Products";
    public static final String LISTTYPE_PRODUCT_BRANDS = "ProductName";
    public static final String LISTTYPE_PRODUCT_CATEGORIES = "ProductItems";
    public static final String LISTTYPE_PRODUCT_LEARNMORE = "LearnMore";

    public static final String SERVICE_TYPE_DEMO = "1";
